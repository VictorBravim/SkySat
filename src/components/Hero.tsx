        ...
        <div className="block h-screen flex items-center justify-center px-16">
            ...
            <div className="relative z-10 text-white w-full lg:w-1/3">
                <div className="text-left mb-4">
                    ...
                    <p className="text-sm md:text-2xl text-gray-500 font-bold mb-4 pr-0 lg:pr-20">Segundo a página da NASA, um satélite é um objeto que orbita ou cerca outro objeto no espaço. Existem dois tipos diferentes de satélites, a saber, naturais e artificiais. Conforme citado pelo Science Learn, de acordo com o Dr. Allan McInnes, um satélite é qualquer coisa que orbita ao redor de um objeto maior.</p>
                </div>
