...
export default function Card() {
    return (
        <div className="w-1/2 absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-40" style={{ marginTop: '980px' }}>
            <div className="container mx-auto flex justify-center space-x-4">
                <div className="bg-blue-custom flex flex-col items-center text-white rounded-lg shadow-lg p-6 text-center w-1/3">
